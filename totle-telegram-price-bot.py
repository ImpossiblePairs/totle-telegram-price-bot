...
# Telegram bot
botToken = "<YOUR ACCESS TOKEN HERE>"
...
def start(bot, update):
    output = "Hi! Welcome to a Totle Price Bot\n"
    output += "To check all prices for a token, use: /check TokenSymbol (ex: /check BAT)\n"
    output += "To check all tokens for arbitrage potential, use: /arbitrage\n"
    update.message.reply_text(output)
